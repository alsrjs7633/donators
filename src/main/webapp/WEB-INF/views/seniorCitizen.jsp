...
<div id="wrap">
  ...
  <div class="explain">
    ...
    <p><b>매달 일정 금액을 꾸준히 후원해 주시면
      <br>
      독거노인에게 더 큰 도움을 줄 수 있습니다.
      <br>
      정기후원은 안정적인 후원금 확보로 독거노인의 행복한 삶을
      <br>
  ...
  <ul>
    <li>
      <div class="first_box">
      <div class="a">
        <img src="/images/seniorCitizen1.png" height="180.77px" width="325.28px">
      </div>
      <div class="b">
        <strong class="ad_title">의료비 지원하기</strong>
      </div>
      <div class="c"> 
        <p>아픈 어르신에게 도움을 줍니다.</p>
      </div>
      <div class="d">
    ...
    <li>
      ...
      <div class="a">
        <img src="/images/seniorCitizen2.png" height="180.77px" width="325.28px">
      </div>
      <div class="b">
        <strong class="ad_title">난방비 지원하기</strong>
      </div>
      <div class="c"> 
        <p>추운 어르신들에게 따뜻한 겨울을 선물하세요.</p>
      </div>
      <div class="d">
        <button type="button" color="yellow" onclick="location.href='/payment' ">후원하기</button>
      </div>
    ...
    <li>
      <div class="third_box">
      <div class="a">
        <img src="/images/seniorCitizen3.png" height="180.77px" width="325.28px">
      </div>
      <div class="b">
        <strong class="ad_title">의류 지원하기</strong>
      </div>
      <div class="c"> 
        <p>어르신들에게 힘이됩니다.</p>
      </div>
